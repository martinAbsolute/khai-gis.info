$(function() {
	...
	var marker = [], infowindow = [], map, image = markerpath;
	...
	function initialize() {
		...
		var styles = [{"featureType":"all","elementType":"all","stylers":[{"saturation":-100},{"gamma":0.5}]},{"featureType":"poi.business","elementType":"geometry","stylers":[{"visibility":"on"}]}]
